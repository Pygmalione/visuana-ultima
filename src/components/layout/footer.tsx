...
export function Footer({
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!email || !onNewsletterSignup) return
        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-charcoal-400 text-sm mb-6 max-w-sm">
                AI-Powered Marketing Agency. Łączymy dane, storytelling i humor, by tworzyć kampanie, które działają.
              </p>
                ...
                <form onSubmit={handleNewsletterSubmit} className="mt-6">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="flex-1 bg-charcoal-800 border-charcoal-700 text-white placeholder-charcoal-500"
                      required
                    />
                    <Button
                      type="submit"
