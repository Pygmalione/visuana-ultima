...
// ============================================
// SEONYU FOOTER - LIGHT THEME
// Minimal | Slate/Blue | 21st.dev Style
// ============================================
...
const socialLinks = [
  {
    platform: 'LinkedIn',
    href: 'https://linkedin.com/company/visuana',
    icon: (
  ...
  {
    platform: 'Twitter',
    href: 'https://twitter.com/visuana',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    platform: 'Instagram',
    href: 'https://instagram.com/visuana',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="py-16 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-slate-500 text-sm mb-6 max-w-sm leading-relaxed font-light">
...
SeonyuFooter.displayName = 'SeonyuFooter'
