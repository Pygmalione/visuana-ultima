...
- [x] Task 3.4: Author Bio Component ✅ (15 tests, karol-frontend-design skill)
...
- **karol-frontend-design** (local skill) - User-scoped
- Path: `~/.claude/skills/karol-frontend-design`
...
| 2025-12-03 | Faza 3-4 ukończona, P0 fixes, karol-frontend-design skill | Claude Code |
